...
; ============================================================================
; geo3d_demo.asm  -  rotating wireframe on the V9968 cartridge, MSX-DOS .COM
;
...
;
; Assemble: z80asm -o GEO3D.COM geo3d_demo.asm
...
palette:                            ; 0 black, 1..14 grey ramp, 15 white
        db 0x00,0x00, 0x11,0x01, 0x11,0x01, 0x22,0x02, 0x22,0x02, 0x33,0x03
        db 0x33,0x03, 0x44,0x04, 0x44,0x04, 0x55,0x05, 0x55,0x05, 0x66,0x06
        db 0x66,0x06, 0x77,0x07, 0x77,0x07, 0x77,0x07

cfg_words:
        dw 256, 128, 106, 16, 256, 212   ; F, CX, CY, ZNEAR, W, H

model_regs:
        db 0, 0, NVERT, NEDGE, 0x0F, 0   ; VADDR, EADDR, NVERT, NEDGE, COLOR, LOP=IMP
